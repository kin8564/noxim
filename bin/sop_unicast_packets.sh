...
RESULTS_FILE="${RESULTS_DIR}/sop_unicast_packets_${TIMESTAMP}.csv"
AVG_RESULTS_FILE="${RESULTS_DIR}/sop_unicast_packets_avg_${TIMESTAMP}.csv"
...
echo ""
echo "================================================"
echo "SOP Unicast Topology PIR Sweep Metrics Test"
echo "================================================"
